...
public class MahJongPresenterTest {
  ...
  @Test
  public void testEmptyTileUsedStateFor1TurnOf1() {
    ...
    Tile tile = null;
    verify(mockView).chooseTile(tile, getTiles(0, 12));
  }
  ...
  @Test
  public void testEmptyTileUsedStateForViewerTurnOf1() {
  ...
  @Test
  public void testNonEmptyTileUsedStateFor1TurnOf2() {
    ...
    verify(mockView).setPlayerState(13, 13, 13, 
    		...
    		82, getTiles(52, 53),
    		getTiles(0, 12), getEmptyTile(),
    		MahJongMessage.INVISIBLE);
  }

  @Test
  public void testNonEmptyTileUsedStateFor2TurnOf2() {
    mahJongPresenter.updateUI(createUpdateUI(bId, bId, nonEmptyTileUsedState));
    verify(mockView).setPlayerState(13, 13, 13, 
    		getEmptyTile(), getEmptyTile(), getEmptyTile(),
    		82, getTiles(52, 53),
    		getTiles(13, 25), getEmptyTile(),
    		MahJongMessage.INVISIBLE);
  }

  @Test
  public void testNonEmptyTileUsedStateForViewerTurnOf2() {
    mahJongPresenter.updateUI(createUpdateUI(viewerId, bId, nonEmptyTileUsedState));
    verify(mockView).setViewerState(13, 13, 13, 13,
    		getEmptyTile(), getEmptyTile(), getEmptyTile(), getEmptyTile(),
    		82, getTiles(52, 53), MahJongMessage.INVISIBLE);
  }
  ...
  public void testGameOverStateForViewer() {
    ...
    verify(mockView).setViewerState(13, 13, 13, 13, 
    		getEmptyTile(), getEmptyTile(), getEmptyTile(), getEmptyTile(),
    		0, getTiles(52, 135), MahJongMessage.INVISIBLE);
  }
